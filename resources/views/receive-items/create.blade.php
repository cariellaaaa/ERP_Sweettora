    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Receive Item Create</h4>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('receive-items.store') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="date" class="form-control @error('trx_date') is-invalid @enderror"
                                    name="trx_date" id="trx_date" value="{{ old('trx_date', date('Y-m-d')) }}" required>
                                @error('trx_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select name="purchase_order_id" id="purchase_order_id"
                                    ...
                                    required>
                                    <option value="" disabled {{ old('purchase_order_id') ? '' : 'selected' }}>Choose
                                        a Purchase Order
                                    </option>
