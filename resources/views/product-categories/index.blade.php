...
@include('product-categories.edit')
@section('content')
<!-- start page title -->
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm">
                        <div class="mb-4">
                            <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#addCategory"><i class="bx bx-plus me-1"></i> Add Category</button>
                    ...
                    <div class="col-sm-auto text-end">
                        <a href="{{ route('product-categories.index') }}" class="btn btn-warning mb-4">Reset Filter</a>
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="table-responsive" style="overflow-y: auto">
                    ...
                    <table class="table align-middle table-check">
                        ...
                        <tbody>
                            <form id="formBulkDelete" action="{{ route('product-categories.destroy', 'id') }}" method="POST">
                                @csrf
                                @method("DELETE")
                                    ...
                                    <td>
                                        {{-- <div class="row">
                                            <div class="col-12 col-md-2">
                                                <a href="{{ route('product-categories.edit', $item->id) }}" class="btn btn-primary">Edit</a>
                                            </div>
                                            <div class="col-12 col-md-2">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item btn-edit" href="#" data-bs-toggle="modal" data-bs-target="#editCategory" data-category="{{ $item }}">Edit</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('product-categories.destroy', $item->id) }}" class="dropdown-item" data-confirm-delete="true">Delete</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
    ...
    <script>
        $(function(){
            $('.btn-edit').click(function(){
                ...
                // console.log(data.id);
                let form = $('#formEdit');
                let url = "{{ route('product-categories.update', ':id') }}".replace(':id', data.id);
