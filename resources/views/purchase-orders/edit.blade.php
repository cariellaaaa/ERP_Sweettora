    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Purchase Order Edit</h4>
                ...
                <form action="{{ route('purchase-orders.update', $purchaseOrder->id) }}" method="POST"
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror"
                                    ...
                                    value="{{ old('code', $purchaseOrder->code) }}">
                                @error('code')
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="number" step="0.01"
                                    ...
                                    value="{{ old('total', $purchaseOrder->total) }}" required>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select name="status" id="status"
                                    ...
                                    <option value="Draft"
                                        {{ old('status', $purchaseOrder->status) == 'Draft' ? 'selected' : '' }}>Draft
                                    </option>
                                    <option value="Quotation"
                                        {{ old('status', $purchaseOrder->status) == 'Quotation' ? 'selected' : '' }}>
                                        Quotation</option>
                                    <option value="Confirmed"
                                        {{ old('status', $purchaseOrder->status) == 'Confirmed' ? 'selected' : '' }}>
                                        Confirmed</option>
                                    <option value="Done"
                                        {{ old('status', $purchaseOrder->status) == 'Done' ? 'selected' : '' }}>Done
                                    </option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" id="description" rows="5"
                                    class="form-control @error('description') is-invalid @enderror">{{ old('description', $purchaseOrder->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('purchase-orders.index') }}" class="btn btn-light">Back</a>
