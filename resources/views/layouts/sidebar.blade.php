            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        ...
                        <span data-key="t-contact">Contact</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li>
                        ...
                        {{-- <li>
                            <a href="#">
                                <span data-key="t-companies">Companies</span>
                            </a>
                        </li> --}}
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        ...
                        <span data-key="t-product">Receive Items</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li>
                ...
                <li class="menu-title" data-key="t-menu">Manufacturing</li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        <i class="fas fa-list-ul"></i>
                        <span data-key="t-product">Bill Of Materials</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li>
