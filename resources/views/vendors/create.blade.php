    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Vendors Create</h4>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('postal_code') }}" name="postal_code" id="postal_code" required>
                                        @error('postal_code')
                                            <span class="invalid-feedback">
                                                {{ $message }}
                                            </span>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('npwp') is-invalid @enderror"
                                            value="{{ old('npwp') }}" name="npwp" id="npwp" required>
                                        @error('npwp')
                                            <span class="invalid-feedback">
                                                {{ $message }}
                                            </span>
